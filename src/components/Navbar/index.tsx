...
const Navbar = () => {
  return(
    <nav className="flex justify-between items-center relative h-20 px-8 bg-blue-700 md:w-[90%] md:rounded-[20px] md:mx-8 mt-8 md:mt-4 lg:flex-col lg:justify-start lg:w-24 lg:h-[960px] lg:mt-8 lg:mx-0 lg:pt-11">
