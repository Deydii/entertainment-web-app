...
const Navbar = () => {
  return(
    <nav className="flex justify-between items-center relative h-20 px-8 bg-blue-700 md:rounded-[20px] md:mx-8 mt-8 lg:flex-col lg:justify-start lg:w-[7%] lg:h-[960px] lg:ml-8 lg:mr-0 lg:pt-11">
