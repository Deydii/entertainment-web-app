const LinksMenu = () => {
  return(
    <ul className="mt-16 space-y-9">
      <li>
        <svg className="fill-[#5A698F] hover:fill-red" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <svg className="fill-[#5A698F] hover:fill-red" width="17" height="20" xmlns="http://www.w3.org/2000/svg">
