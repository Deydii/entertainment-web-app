...
const Card = ({
  ...
  return (
    ...
    <div className="relative w-auto min-[375px]:w-[164px] min-[425px]:w-auto md:w-[220px] lg:w-auto">
      ...
      {isBookmarked ? (
        <div className="flex justify-center items-center absolute z-2 top-3 right-4 rounded-full w-7 h-7 bg-blue-200 hover:cursor-pointer">
          <svg className="" width="12" height="14" xmlns="http://www.w3.org/2000/svg">
