...
const Card = ({
  ...
  return (
    <>
    <div data-testid="cards" className="relative w-auto min-[375px]:w-[164px] min-[425px]:w-auto md:w-[220px] lg:w-auto">
      ...
      : (
        <div data-testid="svg" onClick={() => handleOnClick(title)} className=" group flex justify-center items-center absolute z-2 top-3 right-4 rounded-full w-7 h-7 bg-blue-200 hover:bg-white hover:cursor-pointer">
